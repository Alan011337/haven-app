...
export DATABASE_URL="${DATABASE_URL:-sqlite:///./audit-log-retention-local.db}"
...
export AUDIT_LOG_RETENTION_DAYS="${AUDIT_LOG_RETENTION_DAYS:-365}"

"${PYTHON_BIN}" scripts/run_audit_log_retention_audit.py
"${PYTHON_BIN}" scripts/validate_security_evidence.py --kind audit-log-retention --contract-mode strict
