  ...
  return (
    <div className="space-y-8 md:space-y-10" aria-hidden>
      ...
      <div className="space-y-3">
        <div className="h-10 w-52 animate-pulse rounded-[1.5rem] bg-muted/50" />
        <div className="h-4 w-72 animate-pulse rounded-full bg-muted/30" />
      </div>
      {/* Form card skeleton */}
      <div className="h-56 animate-pulse rounded-[2rem] bg-white/60 shadow-soft" />
      {/* Item skeletons */}
      <div className="space-y-3">
        <div className="h-20 animate-pulse rounded-[1.5rem] bg-white/50" />
        <div className="h-20 animate-pulse rounded-[1.5rem] bg-white/50" />
      </div>
    </div>
  );
