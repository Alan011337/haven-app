...
export const drawDeckCard = async (category: string, forceNew: boolean = false): Promise<CardSession> => {
  ...
  try {
    ...
    logClientError('draw-deck-card-failed', error);
    throw error;
  }
};

// 2. 回答卡片
export const respondToDeckCard = async (
  sessionId: string,
  content: string,
  ...
  try {
    ...
    logClientError('respond-deck-card-failed', error);
    throw error;
  }
};
...
export const fetchDeckHistory = async (query: DeckHistoryQuery = {}): Promise<DeckHistoryEntry[]> => {
  ...
  try {
    ...
    logClientError('fetch-deck-history-failed', error);
    throw error;
  }
};
...
export const fetchDeckHistorySummary = async (
  ...
  try {
    ...
    logClientError('fetch-deck-history-summary-failed', error);
    throw error;
  }
};
...
export const fetchDeckCardCounts = async (): Promise<DeckCardCount[]> => {
  try {
    ...
    logClientError('fetch-deck-card-counts-failed', error);
    throw error;
  }
};
...
export const fetchCardConversation = async (
  ...
  try {
    ...
    logClientError('fetch-card-conversation-failed', error);
    throw error;
  }
};
