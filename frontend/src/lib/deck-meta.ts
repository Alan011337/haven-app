...
export const DECK_META_MAP: Record<CardCategory, DeckMeta> = {
  [CardCategory.DAILY_VIBE]: {
    ...
    color: 'from-chart-4/30 to-chart-4/15',
  ...
  [CardCategory.SOUL_DIVE]: {
    ...
    color: 'from-chart-1/30 to-chart-1/15',
    textColor: 'text-foreground',
  ...
  [CardCategory.SAFE_ZONE]: {
    ...
    color: 'from-chart-2/30 to-chart-2/15',
    textColor: 'text-foreground',
  ...
  [CardCategory.MEMORY_LANE]: {
    ...
    color: 'from-chart-5/30 to-chart-5/15',
    textColor: 'text-foreground',
  ...
  [CardCategory.GROWTH_QUEST]: {
    ...
    color: 'from-chart-3/30 to-chart-3/15',
    textColor: 'text-foreground',
  ...
  [CardCategory.AFTER_DARK]: {
    ...
    color: 'from-depth-3/30 to-depth-3/15',
    textColor: 'text-foreground',
  ...
  [CardCategory.CO_PILOT]: {
    ...
    color: 'from-chart-3/25 to-chart-3/10',
    textColor: 'text-foreground',
    iconColor: 'text-chart-3',
    badgeClass: 'bg-chart-3/15 text-foreground',
    Icon: Plane,
  ...
  [CardCategory.LOVE_BLUEPRINT]: {
    ...
    color: 'from-depth-1/25 to-depth-1/10',
    textColor: 'text-foreground',
